...
docker exec cli configtxgen -outputCreateChannelTx /opt/home/channelb.pb -profile OneOrgChannel -channelID channelb --configPath /opt/home/

# Create a Fabric channel
docker exec -e "CORE_PEER_TLS_ENABLED=true" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/home/managedblockchain-tls-chain.pem" \
    -e "CORE_PEER_ADDRESS=\$PEER" -e "CORE_PEER_LOCALMSPID=\$MSP" -e "CORE_PEER_MSPCONFIGPATH=\$MSP_PATH" \
    cli peer channel create -c channelb -f /opt/home/channelb.pb -o \$ORDERER --cafile \$CAFILE --tls --timeout 900s

# Get the block from the channel itself
docker exec -e "CORE_PEER_TLS_ENABLED=true" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/home/managedblockchain-tls-chain.pem"  \
    -e "CORE_PEER_ADDRESS=\$PEER"  -e "CORE_PEER_LOCALMSPID=\$MSP" -e "CORE_PEER_MSPCONFIGPATH=\$MSP_PATH" \
    cli peer channel fetch oldest /opt/home/fabric-samples/chaincode/hyperledger/fabric/peer/channelb.block \
    -c channelb -o \$ORDERER --cafile /opt/home/managedblockchain-tls-chain.pem --tls

# Join your peer node to the channel
docker exec -e "CORE_PEER_TLS_ENABLED=true" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/home/managedblockchain-tls-chain.pem" \
    -e "CORE_PEER_ADDRESS=\$PEER" -e "CORE_PEER_LOCALMSPID=\$MSP" -e "CORE_PEER_MSPCONFIGPATH=\$MSP_PATH" \
    cli peer channel join -b channelb.block  -o \$ORDERER --cafile \$CAFILE --tls
...
echo docker exec -e "CORE_PEER_TLS_ENABLED=true" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/home/managedblockchain-tls-chain.pem" \
    -e "CORE_PEER_ADDRESS=\$PEER" -e "CORE_PEER_LOCALMSPID=\$MSP" -e "CORE_PEER_MSPCONFIGPATH=\$MSP_PATH" \
    cli peer chaincode instantiate -o \$ORDERER -C \$CHANNEL -n \$CHAINCODENAME -v \$CHAINCODEVERSION \
    -c '{"Args":["init","a","100","b","200"]}' --cafile \$CAFILE --tls >> /tmp/new_stuff2.txt
EOF